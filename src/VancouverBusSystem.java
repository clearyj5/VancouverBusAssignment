...
public class VancouverBusSystem {
  ...
  public void findStopInfo(String stop) {
    ...
    public void showMenu() {
      ...
      TripTwo trip = new TripTwo("stop_times.txt");
        ...
        String inputFromUser = (String) JOptionPane.showInputDialog(
          ...
          switch(inputFromUser){
              ...
              case "3. Find all the trips of a given duration":
                String timeByUser = JOptionPane.showInputDialog("Please enter the arrival time of the trip in the form 'hh:mm:ss'");
                boolean isTimeValid = _isGivenTimeValid(timeByUser);
                if(isTimeValid) {

                  //findTripsWithArrivalTime returns all trip in an arrayList that match the arrival time of the user
